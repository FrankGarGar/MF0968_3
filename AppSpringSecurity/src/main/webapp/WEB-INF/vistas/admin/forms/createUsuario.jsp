...
<div class="container-form">
		...
		<form name="f" action="admin/usuarios/edit" method="POST" enctype="utf8">
			...
			<div class="form-group">
				<input type="text" class="inp" name="username" value="${usuario.username}" placeholder="Username">
			</div>
			<div class="form-group">
				<input type="password" class="inp" name="password" value="${usuario.password }" placeholder="Password">
			</div>
			<div class="form-group">
				<input type="text" class="inp" name="nombre" value="${usuario.nombre }" placeholder="Nombre">
			</div>
			<div class="form-group">
				<input type="text" class="inp" name="apellidos" value="${usuario.apellidos }" placeholder="Apellidos">
			</div>
			<div class="form-group">
				<input type="number" class="inp" name="edad" value="${usuario.edad }" placeholder="Edad">
			</div>
			<div class="form-group">
